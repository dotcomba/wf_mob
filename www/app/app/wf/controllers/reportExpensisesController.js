'use strict';
app.controller('reportExpensisesController', ['$scope', '$routeParams', '$location', '$timeout', '$route', 'transactionsService', 'categoriesService', 'currenciesService', function ($scope, $routeParams, $location, $timeout, $route, transactionsService, categoriesService, currenciesService) {
